...
namespace InventorySaaS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260919052139_AddInventoryTransactionReasonAndSerials")]
    partial class AddInventoryTransactionReasonAndSerials
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventorySaaS.Domain.Entities.Billing.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InventorySaaS.Domain.Entities.Billing.InvoiceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InventorySaaS.Domain.Entities.Billing.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InventorySaaS.Domain.Entities.Billing.PaymentAllocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InventorySaaS.Domain.Entities.Billing.SupplierBill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InventorySaaS.Domain.Entities.Billing.SupplierBillItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InventorySaaS.Domain.Entities.Billing.SupplierPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InventorySaaS.Domain.Entities.Billing.SupplierPaymentAllocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SupplierPaymentId", "SupplierBillId");
            ...
            modelBuilder.Entity("InventorySaaS.Domain.Entities.Billing.InvoiceItem", b =>
                {
                    b.HasOne("InventorySaaS.Domain.Entities.Billing.Invoice", "Invoice")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("InventorySaaS.Domain.Entities.Billing.PaymentAllocation", b =>
                {
                    ...
                    b.HasOne("InventorySaaS.Domain.Entities.Billing.Payment", "Payment")
            ...
            modelBuilder.Entity("InventorySaaS.Domain.Entities.Billing.SupplierBillItem", b =>
                {
                    ...
                    b.HasOne("InventorySaaS.Domain.Entities.Billing.SupplierBill", "SupplierBill")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("InventorySaaS.Domain.Entities.Billing.SupplierPaymentAllocation", b =>
                {
                    ...
                    b.HasOne("InventorySaaS.Domain.Entities.Billing.SupplierPayment", "SupplierPayment")
                        .WithMany("Allocations")
